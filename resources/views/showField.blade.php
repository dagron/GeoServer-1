...
<head>
    ...
    <script>
        ...
        var mapBounds = new GLatLngBounds(new GLatLng(40.969282984, 23.5034099546), new GLatLng(40.9726423255, 23.5052557442));
        var mapMinZoom = 16;
        var mapMaxZoom = 20;
            ...
            if (GBrowserIsCompatible()) {
                ...
                tilelayer.getTileUrl = function(tile,zoom) {
                    ...
                    if (mapBounds.intersects(tileBounds)) {
                        return "{{ URL::to('uploads/user2/imerominia/') }}" + "/" + zoom+"/"+tile.x+"/"+y+".png";
                    } else {
                        return "http://www.maptiler.org/img/none.png";
                    }
                }
...
<body onload="load()">
<div id="header"><h1>field.vrt</h1></div>
