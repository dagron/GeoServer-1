...
class ImageProcessingController
{
    ...
    public function process()
    {
       ...
       if($bands >= 4) {
            ...
            $this->gdal2tiles->generateTiles($vrt_filepath, $this->out_path . 'ndvi_tiles');
            ...
            $this->gdal2tiles->generateTiles($vrt_filepath, $this->out_path . 'cir_tiles');
            ...
            $this->gdal2tiles->generateTiles($vrt_filepath, $this->out_path . 'nir_green_blue_tiles');
 
            $this->bandController->generate_nir_red_blue($this->out_path);
            $vrt_filepath = $this->gdal2tiles->tifToVrt($this->out_path, BandController::nir_red_blue_filename);
            $this->gdal2tiles->generateTiles($vrt_filepath, $this->out_path . 'nir_red_blue_tiles');
